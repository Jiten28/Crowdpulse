...
**"429 RESOURCE_EXHAUSTED / quota exceeded":** you've hit Gemini's daily free-tier request cap for the current model. This app defaults to `gemini-flash-lite-latest` specifically because the newer flagship Flash models have been observed with very tight free-tier quotas (as low as 20 requests/day on `gemini-3.5-flash` as of July 2026), while Flash-Lite consistently reports a much higher daily allowance. If you still hit this, check your live quota at https://ai.dev/rate-limit — it resets daily at midnight Pacific Time.
